...
#define N_TX            16*64 // Number of byte from DUT's output (Burst out of 'FRAME')
...
void Transact_VSync(uint8_t* FrameBuff)
{
  WaitForNegedge(VSYNC);

  for (int i=0; i<64; i++)
    Transact_HSync((uint8_t*)(FrameBuff+(i*16)));
}
